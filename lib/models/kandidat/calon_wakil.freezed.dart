...
CalonWakil _$CalonWakilFromJson(Map<String, dynamic> json) {
  return _CalonWakil.fromJson(json);
}
...
mixin _$CalonWakil {
  ...
  String? get moto => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $CalonWakilCopyWith<CalonWakil> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CalonWakilCopyWith<$Res> {
  factory $CalonWakilCopyWith(
          CalonWakil value, $Res Function(CalonWakil) then) =
      _$CalonWakilCopyWithImpl<$Res>;
  $Res call(
      {int? id,
...
/// @nodoc
class _$CalonWakilCopyWithImpl<$Res> implements $CalonWakilCopyWith<$Res> {
  _$CalonWakilCopyWithImpl(this._value, this._then);

  final CalonWakil _value;
  // ignore: unused_field
  final $Res Function(CalonWakil) _then;
...
/// @nodoc
abstract class _$$_CalonWakilCopyWith<$Res>
    implements $CalonWakilCopyWith<$Res> {
  factory _$$_CalonWakilCopyWith(
          _$_CalonWakil value, $Res Function(_$_CalonWakil) then) =
      __$$_CalonWakilCopyWithImpl<$Res>;
  @override
  $Res call(
      {int? id,
      @JsonKey(name: 'id_jurusan') int? idJurusan,
...
/// @nodoc
class __$$_CalonWakilCopyWithImpl<$Res> extends _$CalonWakilCopyWithImpl<$Res>
    implements _$$_CalonWakilCopyWith<$Res> {
  __$$_CalonWakilCopyWithImpl(
      _$_CalonWakil _value, $Res Function(_$_CalonWakil) _then)
      : super(_value, (v) => _then(v as _$_CalonWakil));

  @override
  _$_CalonWakil get _value => super._value as _$_CalonWakil;
...
/// @nodoc
@JsonSerializable()
class _$_CalonWakil implements _CalonWakil {
  _$_CalonWakil(
      {this.id,
  ...
  factory _$_CalonWakil.fromJson(Map<String, dynamic> json) =>
      _$$_CalonWakilFromJson(json);
  ...
  @override
  String toString() {
    return 'CalonWakil(id: $id, idJurusan: $idJurusan, idOrmawa: $idOrmawa, nim: $nim, nama: $nama, angkatan: $angkatan, kelas: $kelas, foto: $foto, alamat: $alamat, moto: $moto, deletedAt: $deletedAt, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  _$$_CalonWakilCopyWith<_$_CalonWakil> get copyWith =>
      __$$_CalonWakilCopyWithImpl<_$_CalonWakil>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CalonWakilToJson(this);
  }
}

abstract class _CalonWakil implements CalonWakil {
  factory _CalonWakil(
      {final int? id,
      ...
      @JsonKey(name: 'updated_at') final int? updatedAt}) = _$_CalonWakil;

  factory _CalonWakil.fromJson(Map<String, dynamic> json) =
      _$_CalonWakil.fromJson;
